...
export default function Auth() {
  ...
  // === ОБРАБОТЧИК СТАНДАРТНОЙ ФОРМЫ (ВХОД / РЕГ) ===
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        // Устанавливаем данные пользователя вручную в стейт стора
  ...
  // ========================================================
  // === ЭКРАН ВЕРИФИКАЦИИ (ЕСЛИ НУЖЕН КОД ИЗ ПИСЬМА) ===
  // ========================================================
  if (isVerification) {
    return (
      <div className="min-h-[100dvh] bg-admin-bg flex flex-col items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-md bg-admin-card border border-gray-800 p-6 sm:p-8 rounded-2xl shadow-2xl relative z-10 text-center">
          ...
          <form onSubmit={handleVerify} className="space-y-4">
            ...
            {error && (
              <p className="text-red-500 text-sm bg-red-500/10 py-2 rounded-lg">
                {error}
              </p>
            )}
      ...
      <div className="w-full max-w-md bg-admin-card border border-gray-800 p-5 sm:p-8 rounded-2xl sm:rounded-3xl shadow-2xl relative z-10">
        ...
        <div className="flex bg-gray-900 rounded-xl p-1 mb-5 sm:mb-6 border border-gray-800">
          <button
            ...
            className={`flex-1 py-3 sm:py-2.5 rounded-lg text-sm font-bold transition-all ${
              isLogin
        ...
        <div className="mt-8 pt-6 border-t border-gray-800">
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            {/* КРУГЛАЯ КНОПКА ВК (Low-code виджет) */}
            <div className="relative w-14 h-14 hover:scale-105 transition-all duration-300">
              ...
              <div className="absolute inset-0 bg-[#0077FF]/10 rounded-full border border-[#0077FF]/20 z-10 flex items-center justify-center">
                <span className="text-[#0077FF] text-xs font-bold">VK</span>
              </div>
            </div>
