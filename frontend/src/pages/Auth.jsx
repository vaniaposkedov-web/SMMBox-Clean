      ...
      <div className="w-full max-w-md bg-admin-card border border-gray-800 p-5 sm:p-8 rounded-2xl sm:rounded-3xl shadow-2xl relative z-10">
        ...
        <div className="mt-6 pt-6 border-t border-gray-800">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button type="button" className="w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-[#2AABEE]/10 text-[#2AABEE] hover:bg-[#2AABEE] hover:text-white border border-[#2AABEE]/20 font-medium transition-all">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
