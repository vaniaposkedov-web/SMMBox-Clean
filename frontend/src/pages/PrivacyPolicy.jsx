            ...
            <div className="space-y-6 sm:space-y-8 text-sm sm:text-base leading-relaxed text-gray-400">
              ...
              <section>
                ...
                <div className="space-y-3">
                  <p>1.1. Настоящее Соглашение регулирует отношения между Пользователем и сервисом SMMDeck (далее — «Сервис») по использованию функционала платформы автопостинга.</p>
              ...
              <section>
                ...
                <div className="space-y-3">
                  <p>2.1. Настоящая Политика конфиденциальности действует в отношении всей информации, включая персональные данные в понимании применимого законодательства, которую Сервис SMMDeck может получить о Пользователе в процессе использования им веб-сайта.</p>
                  <p>2.2. Использование Сервиса SMMDeck означает безоговорочное согласие Пользователя с настоящей Политикой и указанными в ней условиями обработки его персональных данных.</p>
                  <p>2.3. Настоящая Политика применяется только к Сервису SMMDeck. Оператор не контролирует и не несет ответственности за сайты и сервисы третьих лиц, на которые Пользователь может перейти по ссылке.</p>
                </div>
              </section>
