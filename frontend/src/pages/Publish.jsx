...
const toggleAllAccounts = () => {
  ...
  const handleAiAction = async () => {
    ...
    // 📌 Берем промпт из админки (globalSettings), а если его нет — используем стандартный
    const systemPrompt = globalSettings?.aiPrompt || "Ты профессиональный SMM-маркетолог. Твоя задача: улучшить предоставленный текст поста. Исправь ошибки, сделай текст более вовлекающим, разбей на удобные абзацы и добавь 2-3 подходящих эмодзи. Не выдумывай факты и цены, которых нет в оригинале.";
